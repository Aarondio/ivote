    ...
    <div class="w-full lg:w-1/2 mx-auto">
        <div class="px-4 py-4 bg-white  sm:rounded-lg sm:px-10 ">
            @if ($positions->isNotEmpty())
                <h1 class="text-xl font-semibold mb-4 text-center">New candidate for
                ...
                <form wire:submit.prevent="store">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <select wire:model.lazy="party_id" id=party_ide" name="party_id" required
            ...
            @else
                <div class="py-12 text-center ">
                    <h1 class="mb-4 font-medium text-red-500">No Position has been created for the
                        {{ $election->name . ' ' . $election->start_date->format('Y') }}</h1>
                        <p class="text-slate-500 mb-8 text-sm md:px-20 ">To add new candidates for this election click the button below to create available positions</p>
                        <a href="{{ route('position',$election->id) }}" class="text-white bg-green-500 px-4 py-2 rounded-md hover:bg-green-600">Add Positions</a>
                </div>
            @endif
        </div>
